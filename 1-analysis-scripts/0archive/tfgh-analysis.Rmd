...
- `Se1`, `Sp1`: estimates for Kato-Katz from our study using qPCR as the gold standard
...
#### Run MCMC
Next I run MCMC with 100,000 iterations and four chains. I specify different initial values for each chain. The values for chains 2-3 are completely arbitrary. I need to investigate whether they need to be more thoughtful (probably).
...
For each parameter with 100,000 iterations convergence isn't great. 
