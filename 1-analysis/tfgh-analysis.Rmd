...
#### Run MCMC
Next I run MCMC with 1,000,000 iterations and four chains. I specify different initial values for each chain. The values for chains 2-3 are completely arbitrary. I need to investigate whether they need to be more thoughtful (probably).
...
For each parameter with 1,000,000 iterations convergence isn't great. 
