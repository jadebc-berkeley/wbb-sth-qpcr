...
# 
# 
# # save 8 binary sth plots in one pdf
# saveemplot=function(alplot0,alplot1,hwplot0,hwplot1,ttplot0,ttplot1,sthplot0,sthplot1,lab){
#   pdf(paste("~/Box Sync/WASHB Parasites/Results/Figures/fig-prev-em-",lab,".pdf",sep=""),width=14,height=14)
#   grid.arrange(alplot0,alplot1,hwplot0,hwplot1,ttplot0,ttplot1,sthplot0,sthplot1,ncol=2,nrow=4,widths=c(0.55,0.45))
#   dev.off()
# }
# 
# # save 6 binary sth plots in one pdf
# saveepgemplot=function(alplot0,hwplot0,ttplot0,alplot1,hwplot1,ttplot1,lab){
#   pdf(paste("~/Box Sync/WASHB Parasites/Results/Figures/fig-epg-em-",lab,".pdf",sep=""),width=16,height=11)
#   grid.arrange(alplot0,hwplot0,ttplot0,alplot1,hwplot1,ttplot1,ncol=2,nrow=3)
#   dev.off()
# }
